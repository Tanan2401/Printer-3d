...
#define STRING_CONFIG_H_AUTHOR "(v1)" // Who made the changes.
...
// Show the Marlin bootscreen on startup. ** ENABLE FOR PRODUCTION **f
 ...
 */
  ...
  #define MPC_INCLUDE_FAN               2              // Model the fan speed?
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 69, -7.85, -3 }
...
#if ENABLED(PREHEAT_BLEVELING)
  #define LEVELING_NOZEFORE_ZLE_TEMP 170   // (°C) Only applies to E0 at this time
